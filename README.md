...
- Edit the first line of the LICENSE file in your repo (Note: source of the PiOS license is also available here [github.com/pi-apps/pios/LICENSE](github.com/pi-apps/pios/LICENSE)
