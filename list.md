...
| Global-System for Pi | Develop Apps for Payment Pi Network | Ecosystem Tools | PHP |  | pi://brainstorm.pi/project/649246a072b8d51a2e9d1409 |  [Global System Testnet](https://testnet.gproid.com/) | (When available) |
| Global YouLikePi | Global-Token for pay view Youtube Video with Pi Network | Social Media | PHP |  | pi://brainstorm.pi/project/64a669c8a3fb4d0637e56543 |  [Global YouLikePi Testnet](https://youlikepi.gproid.com/) | (When available) |
| Toko Emas Berlian Harisa | Toko Emas Berlian Harisa, aims to make it easier for pioneers in the world, especially Indonesia, in buying and selling gold and diamonds. | Ecosystem Tools | PHP |  | pi://brainstorm.pi/project/6475b0b22c0abb630dcce93d |  [Toko Emas Berlian Harisa Testnet](https://testnet.harisajewellery.com/) | (When available) |
| GDH-PiFashion | Toko Emas Berlian Harisa, Fashion Division. | Ecosystem Tools | PHP |  | (When available) |  [GDH (Fashion) Testnet](https://testnet.gdh-pifashion.com/) | (When available) |
| GDH-PiCAR | Toko Emas Berlian Harisa, CAR Division. | Ecosystem Tools | PHP |  | (When available) |  [GDH (Car) Testnet](https://testnet.gdh-picar.com/) | (When available) |
| GDH-PiMART | Toko Emas Berlian Harisa, Market Place Division. | Ecosystem Tools | PHP |  | (When available) |  [GDH (Market Place) Testnet](https://testnet.gdh-mart.com/) | (When available) |
