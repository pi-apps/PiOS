...
| Pi Store on Pi | A service platform that gathers physical merchants. Users can choose the nearest store for consumption. | Consumer utilities | SpringCloud、Mysql、Mongodb,redis,Vue3, etc. | [pi_store-on-Pi](https://github.com/hphoh34/pi_store-on-Pi) | pi://brainstorm.pi/project/63c641ea731cc60885ea2f7f | (When available) | (When available) |
