...
| Chicks for Pi | A brand new cultivating & trading game based on Pi Network. | Games | JavaScript, Html, PHP, MySQL | [chicks-for-pi](https://github.com/pi-apps/chicks-for-pi) | N/A | (When available) | (When available) |
| Bull for Pi | A synthetic NFT game that can be traded based on Pi SDK. | Games | JavaScript, Html, PHP, MySQL | [bull-for-pi](https://github.com/pi-apps/bull-for-pi) | N/A | (When available) | (When available) |
| Pet for Pi | An NFT pet-cultive game project based on the world's most accessible blockchain-based ecosystem, Pi Network. | Games, Entertainment,NFT | JavaScript, Html, Golang,Vue,Gin,MySQL,Redis | [pet-for-pi](https://github.com/pi-apps/pet-for-pi) | N/A | [Pet for Pi Testnet](https://pipet.me) | [Pet for Pi Pre-Mainnet](https://www.pipet.me) 
